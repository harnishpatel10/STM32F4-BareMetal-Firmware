...
#define DMA1_MEM_TO_PERIPH		(1U<<6)
...
void dma1_stream6_init(uint32_t src, uint32_t dst, uint32_t len)
{
	...
	DMA1_Stream6->CR &=~ DMA1_CR_EN;

	/*Wait while it is cleared*/
	while(DMA1_Stream6->CR & DMA1_CR_EN){}

	/*Clear all the interrupt flag of Stream 6*/
	DMA1->HIFCR |= (1U<<16);
	DMA1->HIFCR |= (1U<<18);
	DMA1->HIFCR |= (1U<<19);
	DMA1->HIFCR |= (1U<<20);
	...
	DMA1_Stream6->CR |= DMA1_MEM_TO_PERIPH;
